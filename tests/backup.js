...
var clicouAgain = false

function clica() {


  if(clicouAgain = false){
    ...
    document.getElementById("preco").style.opacity = "0";

    document.getElementById("square").style.width = "242px";
    document.getElementById("square").style.height = "249px";

    document.getElementById("ret1").style.width = "242px";
    document.getElementById("ret1").style.height = "44px";

    document.getElementById("laco").style.width = "188px";
    document.getElementById("laco").style.height = "175px";

    document.getElementById("nome-produto").style.marginLeft = "27px";
